...
public class ListViewGiaoDichThoiGian extends BaseAdapter {
    ...
    public ListViewGiaoDichThoiGian(ArrayList<object> araylist, int layoutId, int subLayoutId, Activity activity) {
